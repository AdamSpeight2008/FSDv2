...
Public Class ArgFormat_UnitTests
  ...
  Public Sub _01_()
    ...
    Assert.IsInstanceOfType(res.InnerTokens(0), GetType(FormatString.ArgHole.Format.Head))
#Region "Check Format.Head"
    Dim Head = res.InnerTokens(0)
    Assert.AreEqual("(  0:  1)", Head.Span.ToString)
    Assert.AreEqual(1, Head.InnerTokens.Count)
    Assert.IsInstanceOfType(Head.InnerTokens(0), GetType(FormatString.ArgHole.Format.Colon))
...
#End Region
  ...
  Public Sub _02_()
    ...
    Assert.IsInstanceOfType(res.InnerTokens(0), GetType(FormatString.ArgHole.Format.Head))
    Assert.IsInstanceOfType(res.InnerTokens(1), GetType(FormatString.ArgHole.Format.Body))
#Region "Check Format.Head"
    Dim Head = res.InnerTokens(0)
    Assert.AreEqual("(  0:  1)", Head.Span.ToString)
    Assert.AreEqual(1, Head.InnerTokens.Count)
...
#Region "Check Format.Body"
    ...
    Assert.IsInstanceOfType(BodyText.InnerTokens(0), GetType(FormatString.Common.Brace.Esc.Opening))
...
#Region "Check Format.Body"
    ...
    Assert.AreEqual(1, BodyText.InnerTokens.Count)
    Assert.IsInstanceOfType(BodyText.InnerTokens(0), GetType(ParseError))
    Dim pe = DirectCast(BodyText.InnerTokens(0), ParseError)
    ...
    Assert.IsInstanceOfType(pe.InnerTokens(0), GetType(FormatString.Common.Brace.Opening))
...
#Region "Check Format.Body"
    ...
    Assert.AreEqual(1, BodyText.InnerTokens.Count)
    Assert.IsInstanceOfType(BodyText.InnerTokens(0), GetType(ParseError))
    Dim pe As ParseError = DirectCast(BodyText.InnerTokens(0), ParseError)
    Assert.AreEqual(ParseError.Reason.Invalid, pe.Why)
    Assert.AreEqual("(  1:  1)", pe.Span.ToString)
    Assert.AreEqual(1, pe.InnerTokens.Count)
    Assert.IsInstanceOfType(pe.InnerTokens(0), GetType(FormatString.Common.Brace.Opening))
